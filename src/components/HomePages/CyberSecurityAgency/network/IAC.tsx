...
const servicesData = [
  {
    ...
    shortText:
      "Streamlining infrastructure deployment and management through automation and orchestration tools, enabling rapid provisioning and scalability.      ",
    serviceDetailsLink: "",
    aosDelay: "100",
  },
  {
    ...
    shortText:
      "Ensuring consistency and compliance across infrastructure environments through automated configuration management practices. ",
    serviceDetailsLink: "",
    aosDelay: "200",
  },
  {
    ...
    shortText:
      "Integrating infrastructure automation with DevOps practices to accelerate software development and deployment cycles.",
    serviceDetailsLink: "",
    aosDelay: "300",
  },
  // {
